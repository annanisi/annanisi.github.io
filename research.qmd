...
![From Nisi et al. 2023. Puma survival rate, population growth rate, and several habitat selection metrics across the study area. In the population growth rate panel, areas in blue indicate "sink" areas - places where the population growth rate is negative.](media/source_sink_figure.jpg){width="6in"}
...
![Presenting my ship-strike modeling results to a manager workshop with BWBS.](media/pac-whale_talk.jpg){width="6in"}
...
![The first in-person meeting of the PaC-Whale group in Santa Cruz, CA in 2024.](media/pac-whale_group.jpg){width="6in"}
